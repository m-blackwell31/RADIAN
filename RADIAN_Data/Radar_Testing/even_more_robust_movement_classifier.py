...
# ---------------------------------------------------------
# Adding the edge cases of sitting, bending over, kneeling, slow falling, trip recovery, crawling, a pet walking across the frame, an object dropping, and a true hard fall.
# ---------------------------------------------------------
